...
//Se crean las varibles que contendran la informacion de los identificadores ya creados
...
var clases_tableros=["tablero-abajo","tablero-der","tablero-arriba","tablero-izq"];
var nombre="";



//Despues de que se ingrese un numero de jugadores recargara la pagina y empezara a asigna las cartas
document.addEventListener("DOMContentLoaded",()=>{
	...
	// Se les dara valores y estilos a los identificadores
	...
	//se le agrega un arreglo al identificador cartas monto
	this.carta_monto=document.getElementsByName("cartas_monto")[0];
	//Evento "click" tomar cartas del monto
	this.carta_monto.addEventListener("click",()=>{
		this.tomarMonto(1,0,false);
	});
});

//Al hacer click, se realizara el evento del boton (btn_jugar)
btn_jugar.addEventListener("click",()=>{
	if(Util.esNumero(this.caja_nombre.value) && !Util.esDecimal((this.caja_nombre.value)) && this.caja_nombre.value<=Diccionario.max_jugadores && this.caja_nombre.value>0){
		...
		alert("Numero de jugadores no valido");
	}
});
...
//Funcion para crear los atributos del inicio
function inicio(){
...
//Funcion para crear los atributos del juego
function juego(){
...
//Funcion para crear el tablero y aignarle la posicion a las cartas
...
//Funcion o proceso para cambiar de turno
...
//Funcion tomar monto, lo que permite tomar una carta del monto
...
//Proceso para asignar la posicion de las cartas
